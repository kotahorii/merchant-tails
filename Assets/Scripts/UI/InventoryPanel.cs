...
namespace MerchantTails.UI
{
    ...
    public class InventoryPanel : UIPanel
    {
        ...
        [SerializeField]
        private Transform storefrontContainer;

        [SerializeField]
        private Transform tradingContainer;
        ...
        [SerializeField]
        private Text storefrontCapacityText;

        [SerializeField]
        private Text tradingCapacityText;

        [SerializeField]
        private Slider storefrontCapacityBar;

        [SerializeField]
        private Slider tradingCapacityBar;

        [Header("Item Transfer")]
        [SerializeField]
        private Button transferToStorefrontButton;

        [SerializeField]
        private Button transferToTradingButton;

        [SerializeField]
        private InputField transferQuantityInput;
        ...
        [SerializeField]
        private Transform purchaseItemsContainer;

        [SerializeField]
        private Button confirmPurchaseButton;

        [SerializeField]
        private Text totalPurchaseCostText;
        ...
        [SerializeField]
        private Toggle[] itemTypeToggles;

        [SerializeField]
        private Toggle showExpiredToggle;
        ...
        private void InitializeFilters()
        {
            ...
            if (itemTypeToggles != null)
            {
                for (int i = 0; i < itemTypeToggles.Length && i < 6; i++)
                {
                    int index = i;
                    itemTypeToggles[i]
                        .onValueChanged.AddListener((isOn) => OnFilterToggleChanged((ItemType)index, isOn));
                }
            }
        }
        ...
        {
            if (purchaseItemsContainer == null || inventoryItemPrefab == null)
                return;
        ...
        {
            if (selectedItemInfoText == null || !selectedItemType.HasValue)
                return;
        ...
        private void OnTransferPressed(InventoryLocation targetLocation)
        {
            ...
            // アイテム移動を実行
            bool success =
                InventorySystem.Instance?.MoveItem(selectedItemType.Value, quantity, selectedLocation, targetLocation)
                ?? false;
