...
namespace MerchantTails.UI
{
    ...
    {
        [Header("Navigation")]
        [SerializeField] private Button dayViewButton;
        [SerializeField] private Button weekViewButton;
        [SerializeField] private Button monthViewButton;
        [SerializeField] private Button allTimeViewButton;
        [SerializeField] private GameObject viewButtonContainer;
        ...
        [SerializeField] private TextMeshProUGUI profitMarginText;
        [SerializeField] private TextMeshProUGUI transactionCountText;
        
        [Header("Statistics")]
        [SerializeField] private Transform statisticsContainer;
        ...
        [SerializeField] private ScrollRect transactionScrollRect;
        [SerializeField] private Transform transactionListContainer;
        [SerializeField] private GameObject transactionItemPrefab;
        [SerializeField] private int maxDisplayedTransactions = 100;
        
        [Header("Visual Elements")]
        [SerializeField] private Image profitTrendArrow;
        ...
        private void FilterTransactions()
        {
            ...
            switch (currentViewMode)
            {
                ...
                case JournalViewMode.Week:
                    ...
                    filteredTransactions = allTransactions.Where(t => t.day >= weekStart && t.day <= currentDay).ToList();
                    break;
                    
                case JournalViewMode.Month:
                    int monthStart = Math.Max(1, currentDay - 29);
                    filteredTransactions = allTransactions.Where(t => t.day >= monthStart && t.day <= currentDay).ToList();
                    break;
        ...
        {
            if (profitTrendArrow == null) return;
        ...
        {
            if (transactionListContainer == null || transactionItemPrefab == null) return;
