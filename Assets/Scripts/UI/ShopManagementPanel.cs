...
namespace MerchantTails.UI
{
    ...
    public class ShopManagementPanel : UIPanel
    {
        ...
        [SerializeField] private Text merchantRankText;
        [SerializeField] private Text totalMoneyText;
        [SerializeField] private Text dailyProfitText;
        ...
        [SerializeField] private Text shopCapacityText;
        ...
        [SerializeField] private Text demandInfoText;
        ...
        {
            var timeManager = TimeManager.Instance;
            if (timeManager == null) return "需要情報なし";
        ...
        private void CheckOutOfStockItems()
        {
            // 在庫切れアイテムの通知（簡易実装）
            var storefrontItems = InventorySystem.Instance?.GetStorefrontItems();
            if (storefrontItems == null) return;
