...
namespace MerchantTails.UI
{
    ...
    public class TransactionHistoryItem : MonoBehaviour
    {
        ...
        [SerializeField] private Image transactionTypeIcon;
        [SerializeField] private Image itemIcon;
        
        [Header("Visual Settings")]
        [SerializeField] private Sprite buyIcon;
        [SerializeField] private Sprite sellIcon;
        [SerializeField] private Color buyColor = new Color(1f, 0.8f, 0.8f);
        [SerializeField] private Color sellColor = new Color(0.8f, 1f, 0.8f);
