...
namespace MerchantTails.Tests
{
    ...
    public class DataIntegrityTests
    {
        ...
        public void ItemType_AllValues_AreValid()
        {
            ...
            {
                Assert.IsTrue(System.Enum.IsDefined(typeof(ItemType), itemType), 
        ...
        public void Season_AllValues_AreValid()
        {
            ...
            {
                Assert.IsTrue(System.Enum.IsDefined(typeof(Season), season), 
        ...
        public void MerchantRank_AllValues_AreValid()
        {
            ...
            {
                Assert.IsTrue(System.Enum.IsDefined(typeof(MerchantRank), rank), 
        ...
        public void GameState_AllValues_AreValid()
        {
            ...
            var gameStates = System.Enum.GetValues(typeof(MerchantTails.Core.GameState));
            
            Assert.Greater(gameStates.Length, 0, "GameState should have at least one value");
            
            foreach (MerchantTails.Core.GameState state in gameStates)
            {
                Assert.IsTrue(System.Enum.IsDefined(typeof(MerchantTails.Core.GameState), state), 
        ...
        public void InventoryLocation_AllValues_AreValid()
        {
            ...
            {
                Assert.IsTrue(System.Enum.IsDefined(typeof(InventoryLocation), location), 
        ...
        public void DayPhase_AllValues_AreValid()
        {
            ...
            {
                Assert.IsTrue(System.Enum.IsDefined(typeof(DayPhase), phase), 
        ...
        public void ItemTypeCount_MatchesExpectedNumber()
        {
            ...
            var itemTypes = System.Enum.GetValues(typeof(ItemType));
            Assert.AreEqual(6, itemTypes.Length, "Should have exactly 6 item types (Fruit, Potion, Weapon, Accessory, MagicBook, Gem)");
        }
